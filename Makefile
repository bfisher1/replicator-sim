...
Rep : main.o graphics.o anim.o world.o perlin.o util.o bot.o resourceGraph.o loc.o navigate.o innerWorld.o direction.o block.o
	$(CC) $(CFLAGS) -pthread -O0 -o $@ $^ -lX11 -lm -I/usr/local/include -L/usr/local/lib -lSDL

world.o : world.cpp world.hpp graphics.h perlin.h util.hpp bot.hpp loc.hpp anim.hpp block.hpp
...
clean:
	rm -f main.o graphics.o anim.o world.o perlin.o util.o bot.o resourceGraph.o loc.o innerWorld.o navigate.o direction.o block.o
